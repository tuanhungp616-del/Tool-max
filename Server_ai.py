...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        .logo { font-family: 'Orbitron', sans-serif; font-size: 20px; font-weight: 900; color: var(--primary); text-shadow: 0 0 10px var(--primary); }
...
<body>
    ...
    <header>
        <div class="logo"><i class="fas fa-robot"></i> DORAEMON SYSTEM</div>
    ...
    <script>
        ...
        class Particle {
            ...
            update() { this.x += this.vx; this.y += this.vy; if(this.x > width || this.x < 0) this.vx *= -1; if(this.y > height || this.y < 0) this.vy *= -1; }
            draw() { ctx.beginPath(); ctx.arc(this.x, this.y, 2, 0, Math.PI * 2); ctx.fillStyle = props.particleColor; ctx.fill(); }
        }
